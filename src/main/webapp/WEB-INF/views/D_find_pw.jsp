...
<style type="text/css">
.findpw_field >#go_login:hover{background-color: white;color:black;}
</style>
<script type="text/javascript">
function send_submit_pw(f) {
	f.action="D_find_pw_ok.do";
	f.submit();
}
</script>
</head>
				...
				<fieldset id="field">
					...
					<input type="text" name="id" placeholder="아이디를 입력하세요!">
						...
						<input type="button" value="제출하기" style="width: 150px; height: 50px;font-size:25px;"
									onclick="send_submit_pw(this.form)">
						<hr>
						<br>
						<a href="D_find_id.do" style="color:black; font-size: 25px;">아이디를 찾으시나요?</a>
						<br>
						<br>
						<br>
						<div id="go_login">
